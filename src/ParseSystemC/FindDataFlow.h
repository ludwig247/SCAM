...
namespace SCAM{
        ...
        public:
            FindDataFlow(clang::Stmt *stmt, Module *module, clang::ASTContext &context,bool unsigned_flag=false);
            //Operator
        ...
        private:
            ...
            clang::ASTContext & context; //! AST context FindDataFlow operates on
