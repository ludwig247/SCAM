...
const std::map<std::string, clang::FieldDecl *> & SCAM::FindVariables::getVariableMap() {
    return this->memberMap;
}

const std::map<std::string, std::string> &SCAM::FindVariables::getVariableTypeMap() const {
