...
namespace SCAM {
    ...
    private:
        ...
        void addCompoundDataType(Module *module, std::map<std::string, clang::FieldDecl *> memberMap); //!Adds a new Datatype
        ...
        void addEnumType(const std::map<std::string, QualType> &map);
