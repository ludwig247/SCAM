...
-- FUNCTIONS --
macro foo(test_data: int;test_status: status_t;x: int) : int := 
if(((x + 1) > 5)) then (shift_left(x,1))
elsif(not(((x + 1) > 5)) and not(((x + 1) > 20))) then 0
elsif(not(((x + 1) > 5)) and ((x + 1) > 20)) then (x + test_data)
end if;
end macro; 
